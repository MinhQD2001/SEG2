<?php 
  ...
  $productList->getOwnProducts($_SESSION['user_id']);

  //echo '<pre>' , var_dump($productList->productList[0]) , '</pre>';
  

  if (isset($_POST['post_product'])) {
    $new_Product = new Product($conn);
    $new_Product->checkRegistration($_SESSION['user_id'], $_POST['name'], $_POST['price'], $_POST['quantity'], $_POST['description'], $_POST['post_img'], $_POST['category']);
    //echo '<pre>' , var_dump($new_Product) , '</pre>';
  }

  if (isset($_POST['save'])) {
    $updatedProduct = new Product($conn);
    $updatedProduct->id = $_POST['id'];
    $updatedProduct->name = $_POST['name'];
    $updatedProduct->price = $_POST['price'];
    $updatedProduct->quantity = $_POST['quantity'];
    $updatedProduct->description = $_POST['description'];
    $updatedProduct->post_img = $_POST['post_img'];
        ...
        <div class="row">
            <div class="col-md-9">
              <div class="my-product text-white">
                ...
                <div class="products">
                  <div class="row">
                    <?php $productList->outputOwnProducts(); ?>
                  </div>
                </div>
              </div>
            </div>
